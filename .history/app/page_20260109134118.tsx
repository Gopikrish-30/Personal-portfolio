            ...
            {[
              {
                ...
                description: "Fine-tuned a large language model for high-quality English to Tamil translation using the M2M100 seq2seq model,improved accuracy and fluency, and deployed on Hugging Face.",
                image: "/engtotam.png?height=192&width=384",
                technologies: ["Python", "LLMs", "NLP", "Hugging Face"],
                liveUrl: "https://huggingface.co/gopi30/english-to-tamil-stage5", 
                gradient: "from-blue-500/20 to-purple-500/20"
              },
              {
                id: 2,
                title: "AI-Powered Quiz Generation App",
                description: "Built a smart quiz platform that generates questions from uploaded PDFs, Word, and PowerPoint files using Google Gemini AI. Features multiple-choice quizzes with explanations.",
                image: "/quizzy.png?height=192&width=384",
                technologies: ["Vite", "Gemini", "Vercel", "LLMs"],
                liveUrl: "https://quizzy-app-gopi30.vercel.app/",
                githubUrl: "https://github.com/Gopikrish-30/Quizzy-AI-Powered-Quiz-App", // Only GitHub available
                gradient: "from-green-500/20 to-teal-500/20"
              },
              {
                id: 3,
                title: "Personal portfolio",
                description: "A personal portfolio website to showcase my technical skills, featured projects, certifications, achievements, and career journey. Thoughtfully designed with modern UI, clean layout, and responsive user experience.                  ",
                image: "/protfolio.png?height=192&width=384",
                technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Vercel"],// Both available - update with actual URLs
                githubUrl: "https://github.com/Gopikrish-30",
            ...
            {[
              {
                ...
                verifyUrl: "https://www.crhttps://www.linkedin.com/in/gopi-m-181a06249/details/certifications/1736750627843/single-media-viewer/?profileId=ACoAAD2NMXEB82A5U9fV2WE_tCfEoqPIqGpLehMedly.com/badges/your-badge-id", // Add your actual IBM credential URL
              },
              {
                ...
                verifyUrl: "https://www.coursera.org/account/accomplishments/verify/your-certificate-id", // Add your actual Coursera certificate URL
              },
              {
              ...
              {
                title: "Data Analytics with Exel",
                issuer: "Microsoft",
                date: "2023",
                
                verifyUrl: "https://learn.microsoft.com/en-us/users/your-profile/credentials/your-cert-id", // Add your actual Microsoft Learn URL
              },
              ...
              >
                <div className="flex items-start justify-between mb-3 sm:mb-4">
                  ...
                  {cert.verifyUrl && cert.verifyUrl !== "#" && (
                    ...
                    >
                      <ExternalLink className="w-3 h-3 sm:w-4 sm:h-4 cursor-pointer" />
                    </a>
                  )}
                </div>
            ...
            {[
              {
                ...
                date: "2025",
                description:
                  "Won a national 24-hour hackathon by building Mentora, an AI co-pilot that streamlines course creation and frees educators from weeks of manual effort",
                icon: "🏆",
              },
              {
              ...
              },
              {
                ...
                date: "2025",
                description:
                  "Built a competitive Python bot (snake-in-a-box) that outperformed peers in the Big O Battle technical event",
                icon: "🥇",
              },
