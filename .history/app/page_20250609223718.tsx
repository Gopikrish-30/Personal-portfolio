            ...
            {[
              {
                ...
                description: "Fine-tuned a large language model for high-quality English to Tamil translation using M2M100 se model. Built with Python and PyTorch, and deployed on Hugging Face for real-time inference. learning model that analyzes social media sentiment using NLP techniques and deep learning. Built with Python, TensorFlow, and deployed on Hugging Face.",
