...
export default function Portfolio() {
  return (
    <div className="min-h-screen">
      ...
      description: "A professional portfolio website to showcase my technical skills, featured projects, certifications, and career journey. Designed with a clean layout and responsive user experience."
                image: "/iit-website.jpg?height=192&width=384",
                technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Vercel"],
                liveUrl: "#", // Both available - update with actual URLs
