          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              },
              {
                ...
                description: "Built a smart quiz platform that generates questions from uploaded PDFs, Word, and PowerPoint files using Google Gemini AI. Features multiple-choice quizzes with explanations dashboard for analyzing business metrics with real-time data visualization. Features dynamic charts, filters, and export capabilities.",
                image: "/dashboard.jpg?height=192&width=384",
                technologies: ["React", "D3.js", "Python", "FastAPI"],
                liveUrl: null, // No live demo
                githubUrl: "https://github.com/Gopikrish-30", // Only GitHub available
