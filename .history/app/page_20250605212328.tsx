  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="sticky top-0 z-40 bg-background/80 backdrop-blur-md flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 md:px-12 border-b border-border">
        <div className="text-foreground font-semibold text-lg">Your Name</div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-4 sm:space-y-6">
              <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
                {
                  "I'm a passionate full-stack developer with a keen eye for design and user experience. I love creating digital solutions that not only look great but also solve real-world problems."
                }
              </p>
              <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
                With expertise in modern web technologies, I bring ideas to life through clean code and intuitive
                interfaces.
              </p>
              <div className="flex flex-wrap gap-2 sm:gap-3 justify-center">
                {["React", "Next.js", "TypeScript", "Node.js", "Python", "UI/UX"].map((skill) => (
                  <span
                    key={skill}
