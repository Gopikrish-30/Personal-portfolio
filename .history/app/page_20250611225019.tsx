          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              },
              {
                ...
                description: "A Personal portfolio website to showcase my technical skills, featured projects, certifications, achi career journey. Designed with a clean layout and responsive user experience.",
